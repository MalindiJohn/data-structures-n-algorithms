...
console.log(removeDuplicates([1, 1, 1, 1, 1, 1])); // Output 1
console.log(removeDuplicates([1, 1, 1, 1, 1, 1, 1])); // Output 1
console.log(removeDuplicates([1, 1, 1, 1, 1, 1, 1, 1])); // Output 1