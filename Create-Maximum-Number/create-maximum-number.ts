...
console.log(maxNumber([3, 9], [8, 9], 3)); // expected [9, 8, 9]
console.log(maxNumber([3, 9], [8, 9], 4)); // expected [9, 8, 9]
console.log(maxNumber([3, 9], [8, 9], 5)); // expected [9, 8, 9]
console.log(maxNumber([3, 9], [8, 9], 6)); // expected [9, 8, 9]
console.log(maxNumber([3, 9], [8, 9], 7)); // expected [9, 8, 9]
console.log(maxNumber([3, 9], [8, 9], 8)); // expected [9, 8, 9]